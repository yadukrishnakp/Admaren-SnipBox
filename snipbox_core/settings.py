...
ROOT_URLCONF = 'snipbox_core.urls'
...
WSGI_APPLICATION = 'snipbox_core.wsgi.application'
...
REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'snipbox_core.exceptions.exceptions.handle_exception',
...
AUTHENTICATION_BACKENDS = [
    ...
    'snipbox_core.utils.auth_handler.UserCustomAuthenticator'
]
